...
public class TeacherRestController {
    ...
    @ApiResponses({
            ...
            // // TODO: check if this is also a possible response...
            // @ApiResponse(responseCode = "404", description = "Teacher(s) not found",
            //         content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDTO.class))
            // ),
            @ApiResponse(
    ...
    @GetMapping
    public ResponseEntity<Page<TeacherReadOnlyDTO>> getTeachersPaginatedFiltered(
            @PageableDefault(page = 0, size = 5) Pageable pageable, @ModelAttribute TeacherFilters filters // @ModelAttribute instantiates filters with no-args constructor
